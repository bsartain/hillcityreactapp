...
function FooterDrawer() {
  ...
  const setImage = !store.sermonStore.singleSermonData ? null : store.sermonStore.singleSermonData.better_featured_image.media_details.sizes.medium_large.source_url;
