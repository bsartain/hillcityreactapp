        ...
        {singleSermonData.length === 0
          ...
          : <div>
                ...
                <div className="page-content-title">
                    ...
                    <h2 className="container" dangerouslySetInnerHTML={{__html: singleSermonData.title.rendered}} />
                    <hr className="page-content-hr" />
                </div>
                <div className="single-sermon-details container">
                  <div>
                    <p><span className="item-detail">Preacher: </span>{ setPreacher(singleSermonData.wpfc_preacher) } </p>
                  </div>
                  <div>
                    <p><span className="item-detail">Series:</span> { setSermonSeries(singleSermonData.wpfc_sermon_series) }</p>
                  </div>
                  <div>
                ...
                <div className="container single-sermon-bible-container">
                  <div dangerouslySetInnerHTML={{__html: biblePassage.passages.map(verses => verses)}} />
                </div>
